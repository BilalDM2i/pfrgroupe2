# -*- coding: utf-8 -*-
"""
Created on Wed Jul  3 14:54:08 2024
...
predict_df = pd.read_csv('finale.csv')
...
vainqueur_predict_df = predict_df[['Home_Team', 'Away_Team', 'home_result_pred', 'away_result_pred']]
...
def get_winner(row):
    if row['home_result_pred'] == 1:
        ...
        return 'Match Nul'  # Si les deux résultats sont 0 ou 1, c'est un match nul

vainqueur = vainqueur_predict_df.apply(get_winner, axis=1)


# Afficher le vainqueur
print("Le grand vainqueur des JO est :\n\n\n ------------------------------------------------------------------- \n\n\n",vainqueur)