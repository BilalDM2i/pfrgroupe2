# Scraping des statistiques championnat Afrique (site wikipédia)
# Emie
# Création : 04/06/2024
...
sauvegarde_df_csv(df_palmares, "resultats_scraping/palmares_handball_afrique_hommes.csv")
...
# Sauvegarder les données dans un fichier CSV
sauvegarde_df_csv(df_tableau_medailles, "resultats_scraping/tableau_medailles_afrique_hommes.csv")
...
for row in table.find_all('tr')[1:]:
    ...
    for cell in cells:
        ...
        if span:
            ...
            elif span['data-sort-value'] in ('98', '99'):
                cell_text = np.nan
            else:
...
# Sauvegarder les données dans un fichier CSV
sauvegarde_df_csv(df_bilan_nation, "resultats_scraping/bilan_nations_afrique_hommes.csv")
