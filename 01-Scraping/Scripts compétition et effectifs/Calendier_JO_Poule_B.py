...
table_index = 11  # Modifier cet index pour choisir un autre tableau sur la page
...
try:
    ...
    save_to_csv(df, 'calendrier_jo_poule_B.csv')
    print("Le tableau a été scrappé et sauvegardé en tant que calendrier_jo_poule_B.csv")
