...
while year > 1999:
    ...
    url=f'https://www.flashscore.fr/handball/monde/jeux-olympiques-{year}/resultats/'
    # Ouvrir la page
    driver.get(url)
...
file_path_jo = "resultats_scraping/jo.csv"
df.to_csv(file_path_jo, index=False)
print(f"Les donn�es ont �t� sauvegard�es dans {file_path_jo}")
