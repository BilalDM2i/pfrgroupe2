...
while year > 2000:
    # URL
    url = f'https://www.flashscore.fr/handball/monde/championnat-du-monde-{year}/resultats/'
...
sauvegarde_df_csv(df, "resultats_scraping/scores_mondiaux.csv")
