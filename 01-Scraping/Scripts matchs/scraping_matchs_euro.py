...
while year > 1999:
    # URL
    url = f'https://www.flashscore.fr/handball/europe/championnat-d-europe-{year}/resultats/'
...
file_path_euros = "resultats_scraping/euros.csv"
df.to_csv(file_path_euros, index=False)
print(f"Les donn�es ont �t� sauvegard�es dans {file_path_euros}")
