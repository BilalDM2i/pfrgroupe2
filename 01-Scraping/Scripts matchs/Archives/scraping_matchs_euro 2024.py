...
url = 'https://www.flashscore.fr/handball/europe/championnat-d-europe-2024/resultats/'
...
file_path_euro2024 = "resultats_scraping/euro2024.csv"
df.to_csv(file_path_euro2024, index=False)
print(f"Les données ont été sauvegardées dans {file_path_euro2024}")
