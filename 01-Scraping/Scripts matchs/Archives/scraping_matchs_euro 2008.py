...
url = 'https://www.flashscore.fr/handball/europe/championnat-d-europe-2008/resultats/'
...
file_path_euro2008 = "resultats_scraping/euro2008.csv"
df.to_csv(file_path_euro2008, index=False)
print(f"Les données ont été sauvegardées dans {file_path_euro2008}")
