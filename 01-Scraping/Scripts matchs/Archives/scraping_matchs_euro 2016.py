...
url = 'https://www.flashscore.fr/handball/europe/championnat-d-europe-2016/resultats/'
...
file_path_euro2016 = "resultats_scraping/euro2016.csv"
df.to_csv(file_path_euro2016, index=False)
print(f"Les données ont été sauvegardées dans {file_path_euro2016}")
