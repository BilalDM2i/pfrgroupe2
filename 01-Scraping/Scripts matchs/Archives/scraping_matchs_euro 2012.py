...
url = 'https://www.flashscore.fr/handball/europe/championnat-d-europe-2012/resultats/'
...
file_path_euro2012 = "resultats_scraping/euro2012.csv"
df.to_csv(file_path_euro2012, index=False)
print(f"Les données ont été sauvegardées dans {file_path_euro2012}")
