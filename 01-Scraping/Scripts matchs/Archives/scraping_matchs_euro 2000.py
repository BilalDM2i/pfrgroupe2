...
url = 'https://www.flashscore.fr/handball/europe/championnat-d-europe-2000/resultats/'
...
file_path_euro2000 = "resultats_scraping/euro2000.csv"
df.to_csv(file_path_euro2000, index=False)
print(f"Les données ont été sauvegardées dans {file_path_euro2000}")
