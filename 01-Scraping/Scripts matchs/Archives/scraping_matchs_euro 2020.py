...
url = 'https://www.flashscore.fr/handball/europe/championnat-d-europe-2020/resultats/'
...
file_path_euro2020 = "resultats_scraping/euro2020.csv"
df.to_csv(file_path_euro2020, index=False)
print(f"Les données ont été sauvegardées dans {file_path_euro2020}")
