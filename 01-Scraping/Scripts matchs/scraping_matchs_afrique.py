# Scraping des résultats des championnats d'Afrique (scores de chaque match)
# Emie
# Création : 01/07/2024
# Dernière modif :
...
while year >= 2000:
    # URL
    url = f'https://www.flashscore.fr/handball/afrique/championnat-d-afrique-{year}/#/pAKkAu9s/table'
...
sauvegarde_df_csv(df, "resultats_scraping/scores_afrique.csv")
