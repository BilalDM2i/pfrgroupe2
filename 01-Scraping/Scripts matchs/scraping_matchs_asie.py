...
while year > 1999:
    # URL
    url = f'https://www.flashscore.fr/handball/asie/championnat-d-asie-{year}/resultats/'
...
file_path_asie = "asie.csv"
df.to_csv(file_path_asie, index=False)
print(f"Les donn�es ont �t� sauvegard�es dans {file_path_asie}")
