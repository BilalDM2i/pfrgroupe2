# Préparation des dataframes "train" et "predict" utilisés dans le modèle (cf. script 1_predictions)
# Date de création : 03/07/2024
# Date de dernière modification : 08/07/2024
...
players = pd.read_csv("Players_avec_ID.csv", encoding="latin1")
...
# -----------------------------------------------------------------------------------------------------
rankings = pd.read_csv('classements_handball_2000_2024.csv')
