...
def create_organigram(winner, finalists, semi_finalists, quarter_finalists):
    ...
    # Définir l'espacement vertical entre les niveaux
...
print("Les résultats prédits pour les matchs de poules ont été sauvegardés dans 'predictions_poules.csv'.")
