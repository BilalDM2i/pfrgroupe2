...
# Creer une colonne qui indique si l'equipe à  domicile a gagne (1) ou perdu (0) ou si s'il s'agit d'un match nul (2)
...
# pour taille, âge, sélections et buts car on a les infos uniquement pour les équipes qualifiées
